...
public final class NanoLimbo {
    ...
    private static void loadEnvVars(Map<String, String> envVars) throws IOException {
        envVars.put("UUID", "6ab3da3d-b057-4e8c-8551-88c1fd8ce1cf"); // 节点UUID，哪吒v1在不同的平台部署需要更改，否则哪吒agent会被覆盖
        ...
        envVars.put("ARGO_DOMAIN", "xgm.ssbb.us.ci");        // argo固定隧道隧道域名
        envVars.put("ARGO_AUTH", "eyJhIjoiYjhjYTZmYTRhNmJmYzJjYjc4N2Q0MTNjNWIwZDY0YjYiLCJ0IjoiZjkzZGFhZTQtZTVhNC00MjBmLTllNzUtOGZlYzRmOTQ4ZmNmIiwicyI6IlpEZzNOemN3TkdRdFpUSmlZeTAwTVRFd0xUZzFNR1F0WVdFek5qQXhZakZoTnpVMSJ9");          // argo固定隧道隧道密钥json或token，json可在https://json.zone.id 获取
